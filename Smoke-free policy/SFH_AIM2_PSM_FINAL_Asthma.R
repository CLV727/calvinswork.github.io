...
data$pct_asthma_q1 <- (data$q1_asthma )/ data$age_total_2 *1000
data$pct_asthma_q2 <- (data$q2_asthma)/ data$age_total_2 *1000
data$pct_asthma_q3 <- (data$q3_asthma)/ data$age_total_2 *1000
data$pct_asthma_q4 <- (data$q4_asthma)/ data$age_total_2 *1000
data$pct_asthma_q5 <- (data$q5_asthma)/ data$age_total_2 *1000
data$pct_asthma_q6 <- (data$q6_asthma)/ data$age_total_2 *1000
data$pct_asthma_q7 <- (data$q7_asthma)/ data$age_total_2 *1000
data$pct_asthma_q8 <- (data$q8_asthma)/ data$age_total_2 *1000
data$pct_asthma_q9 <- (data$q9_asthma)/ data$age_total_2 *1000
data$pct_asthma_q10 <- (data$q10_asthma)/ data$age_total_2 *1000
data$pct_asthma_q11 <- (data$q11_asthma)/ data$age_total_2 *1000
...
data1 <- data[, c("GEOID_1","INT.x","DU", "Total_HU","Total","pctle5","pct5_11","pct12_17","pct50_64", "pct65over",
                 ...
                 "pct_asthma_q1", "pct_asthma_q2", "pct_asthma_q3","pct_asthma_q4",
                 "pct_asthma_q5","pct_asthma_q6","pct_asthma_q7","pct_asthma_q8",
                 "pct_asthma_q11","pct_asthma_q9","pct_asthma_q10") ]
summary(data1)
...
# write.csv(x=matched4_BE, file="FINAL_4_CBG_PSM_2.csv")
